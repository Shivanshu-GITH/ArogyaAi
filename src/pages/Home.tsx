...
import { ArrowRight, MessageCircle, Brain, Mic, Globe, Shield, Bell, Smartphone, Users, TrendingUp, CheckCircle, MapPin } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              {getTranslation(language, 'home.chatbots.title')}
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              {getTranslation(language, 'home.chatbots.subtitle')}
            </p>
          </div>
