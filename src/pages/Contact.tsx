  ...
  const contactInfo = [
    {
      ...
      details: 'startupstx@gmail.com',
      descKey: 'contact.emailDesc',
      action: 'mailto:startupstx@gmail.com'
    },
    {
      icon: Phone,
      titleKey: 'contact.callUs',
      details: '+91 8882183479',
      descKey: 'contact.callDesc',
      action: 'tel:+918882183479'
    },
    {
      icon: MessageSquare,
      ...
      action: 'https://wa.me/918882183479'
    }
  ];
          ...
          >
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <a
                    href="https://docs.google.com/forms/d/e/1FAIpQLSceel7bBmsb4k-j9W_PKRD5lxB4BsadSGvfK_iWIVDKigd52Q/viewform?usp=header"
                    target="_blank"
