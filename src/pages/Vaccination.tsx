...
const Vaccination = () => {
  ...
  const handleWhatsAppAlert = () => {
    ...
    const message = `Hello ArogyaAI! I want to subscribe to vaccination reminders and health alerts. Please send me notifications for:\n\n1. Vaccination reminders and due dates\n2. Vaccination drive announcements\n3. Health outbreak alerts\n4. Important vaccination updates\n\nMy phone number: ${phoneNumber}\n\nThank you!`;
    const whatsappUrl = `https://wa.me/918882183479?text=${encodeURIComponent(message)}`;
