      ...
      if (twilioClient && twilioPhoneNumber) {
        try {
          const welcomeMessage = language === 'hi' 
            ? `🩺 ArogyaAI में आपका स्वागत है! आपने सफलतापूर्वक स्वास्थ्य अलर्ट के लिए सदस्यता ले ली है। हम आपको महत्वपूर्ण स्वास्थ्य जानकारी भेजेंगे।`
            : `🩺 Welcome to ArogyaAI! You've successfully subscribed to health alerts. We'll send you important health information and reminders.`;
  ...
  router.get('/qr', async (req: Request, res: Response) => {
    try {
      ...
      const message = encodeURIComponent(
        'Hello ArogyaAI! I want to start using your health services. Please help me with:\n\n' +
